...
function findDistance($uAlatlon, $uBlatlon){
    ...
    $totalDist .= ' ('.sprintf("%0.2f",$km).' kilometers)' ;
...
while ($row = mysqli_fetch_array($user_query, MYSQLI_ASSOC)) {
    ...
    $uAlatlon = $row["latlon"];
    $db_identifier = $row["identifier"];
    $db_profileURL = $row["profileURL"];
     $db_webSiteURL = $row["webSiteURL"];
     $db_photoURL = $row["photoURL"];
     ...
     $db_firstName = $row["firstName"];
         ...
         $db_birthMonth = $row["birthMonth"];
         $db_birthYear = $row["birthYear"];
         $db_emailVerified = $row["emailVerified"];
         $db_phone = $row["phone"];
...
if (isset($log_username)) {
    $result = mysqli_query($db_conx, "SELECT latlon FROM users WHERE username='$log_username' LIMIT 1");
...
<div id="pageMiddle">
  ...
  <p>this user distance: <?php echo $totalDist; ?></p>
 <p>this user identifier: <?php echo $db_identifier; ?></p>
 <p>this user profileURL: <?php echo $db_profileURL; ?></p>
<p>this user webSiteURL: <?php echo $db_webSiteURL; ?></p>
<p>this user photoURL: <?php echo $db_photoURL; ?></p>
<p>this user displayName: <?php echo $db_displayName; ?></p>
<p>this user description: <?php echo $db_description; ?></p>
    <p>this user firstName: <?php echo $db_firstName; ?></p>
<p>this user lastName: <?php echo $db_lastName; ?></p>

<p>this user language: <?php echo $db_language; ?></p>
<p>this user age: <?php echo $db_age; ?></p> 
  
<p>this user birthDay: <?php echo $db_birthDay; ?></p>
<p>this user birthMonth: <?php echo $db_birthMonth; ?></p>
<p>this user birthYear: <?php echo $db_birthYear; ?></p>
<p>this user emailVerified: <?php echo $db_emailVerified; ?></p>
<p>this user phone: <?php echo $db_phone; ?></p>
<p>this user address: <?php echo $db_address; ?></p>
<p>this user region: <?php echo $db_region; ?></p>
<p>this user city: <?php echo $db_city; ?></p>
<p>this user zip: <?php echo $db_zip; ?></p>
